...
set -euo pipefail
mkdir -p /var/lib/intnexus/sessions /var/lib/intnexus-test/sessions
rename_unit() {
  local old="$1"
  local new="$2"
...
Path(r'D:\int\tools\.tmp\20260424T161500\finish_stdout.txt').write_bytes(r.stdout)
Path(r'D:\int\tools\.tmp\20260424T161500\finish_stderr.txt').write_bytes(r.stderr)
print(r.returncode)
print(r'D:\int\tools\.tmp\20260424T161500\finish_stdout.txt')
print(r'D:\int\tools\.tmp\20260424T161500\finish_stderr.txt')
