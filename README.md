...
- `python -m unittest codex.tests.test_publish_repo -v` — regression smoke для `publish_repo.ps1`: clean-tree guard, `-NoDeploy` publish и `partial_state` при post-push deploy failure;
