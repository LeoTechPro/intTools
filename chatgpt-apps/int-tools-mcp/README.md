...
It must not expose generic internal dispatch, OpenSpec tools, coordctl tools, Multica operations, publish/sync wrappers, browser launch, DB apply, or vault non-dry-run.
