---
name: react
description: 'React 19: паттерны и стандарты фронтенда (hooks, Suspense, типизация,
  тесты, a11y, perf).'
---
...
- `references/frontend-standards.md` - Hooks, state management, testing, accessibility, and performance checklists.
- `references/hooks-patterns.md` - Deep dive on built-in hooks and custom hook patterns.
- `references/react-19-patterns.md` - React 19 compiler, actions, and modern patterns.
