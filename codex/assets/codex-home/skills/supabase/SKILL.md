---
name: supabase
description: 'Supabase: CLI-автоматизация, конфигурация auth, Edge Functions, RPC/pgvector,
  секреты, MCP и Management API.'
---
...
**Setup MCP Server:**
```bash
# Example MCP client config (adjust to your client)
{
  "mcpServers": {
    "supabase": {
...
- `references/edge-functions.md` - Edge Functions invocation, deployment, and templates.
- `references/rpc-manager.md` - RPC execution, pgvector usage, and realtime patterns.
