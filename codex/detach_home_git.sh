...
ASSETS_ROOT="${ASSETS_ROOT:-/git/scripts/codex/assets/codex-home}"
...
note=edit managed assets in /git/scripts/codex/assets/codex-home and refresh runtime via /git/scripts/codex/sync_runtime_from_repo.sh
EOF
