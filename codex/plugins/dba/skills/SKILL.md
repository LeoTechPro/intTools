---
name: dba
description: Internal intData skill entrypoint for the dba plugin. Use as the router for dba doctor/status, read-only SQL smoke, migrations, and controlled SQL apply workflows.
---
