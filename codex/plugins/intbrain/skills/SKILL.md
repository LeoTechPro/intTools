---
name: intbrain
description: Internal intData skill entrypoint for the intbrain plugin. Use as the router for IntBrain context, memory, people graph, policies, jobs, PM dashboard, session sync, and external import workflows.
---
