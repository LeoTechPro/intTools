...
description: Internal intData skill entrypoint for the intdata-runtime plugin. Use as the router for host diagnostics, SSH routes, fallback Firefox DevTools browser testing, and runtime vault maintenance.
---
